...
import io, aiohttp, requests
from PIL import Image, ImageDraw, ImageOps


def _fixed_icon(user_id: str, user_avatar: str) -> Image:
	"""
	...
	:rtype Image
	"""
	_user_avatar = "https://cdn.discordapp.com/avatars/{}/{}.png".format(str(user_id), str(user_avatar))
